...
F3_MAIT = mat_cdr3_pair[grepl("F3",rownames(mat_cdr3_pair)),]
F5_MAIT = mat_cdr3_pair[grepl("F5",rownames(mat_cdr3_pair)),]
ComputeShannonIndex(colSums(F3_MAIT)[colSums(F3_MAIT)>1]) # 0.9917927
ComputeShannonIndex(colSums(F5_MAIT)[colSums(F5_MAIT)>1]) # 0.9831899
