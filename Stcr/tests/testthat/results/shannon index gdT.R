...
F3_gdT = mat_cdr3_pair[grepl("F3",rownames(mat_cdr3_pair)),]
F5_gdT = mat_cdr3_pair[grepl("F5",rownames(mat_cdr3_pair)),]
ComputeShannonIndex(colSums(F3_gdT)[colSums(F3_gdT)>1]) #0.805739
ComputeShannonIndex(colSums(F5_gdT)[colSums(F5_gdT)>1]) #0.7543949
